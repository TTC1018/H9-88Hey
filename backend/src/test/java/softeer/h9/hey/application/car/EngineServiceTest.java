...
class EngineServiceTest {
    ...
    void searchEngineTest() {
        int modelId = 1;
        Engine engine1 = new Engine(1, 10000, modelId, "name", "imageURL", "descprition", "maximumPower", "maximumTorque");
        Engine engine2 = new Engine(2, 10000, modelId, "name", "imageURL", "descprition", "maximumPower", "maximumTorque");
