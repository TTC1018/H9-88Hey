...
class PasswordEncoderTest {
	...
	private final PasswordEncoder passwordEncoder = new PasswordEncoder("salt", "SHA-256");
	...
	void comparePasswordWithEncodedPasswordSuccessTest() {
		String password = "12345678";
		String encodedPassword = passwordEncoder.encode(password);
	...
	void comparePasswordWithEncodedPasswordFailTest() {
		String password1 = "12345678";
		String password2 = "abcdefgh";
		String encodedPassword = passwordEncoder.encode(password1);

		Assertions.assertFalse(passwordEncoder.compare(password2, encodedPassword));
	}
}
