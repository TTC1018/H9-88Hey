  ...
  engines: [
    {
      ...
      imageUrl: 'https://www.hyundai.com/contents/spec/guide/lx_gasoline3.8_s.jpg',
      description: '높은 토크로 파워풀한 드라이빙이 가능하며, 차급대비 연비 효율이 우수합니다.',
      maximumPower: '202/3,800PS/rmp',
    ...
    },
    {
      ...
      name: '가솔린 3.8',
      additionalPrice: 1480000,
      imageUrl: 'https://www.hyundai.com/contents/spec/guide/lx_diesel2.2_s.jpg',
      description:
