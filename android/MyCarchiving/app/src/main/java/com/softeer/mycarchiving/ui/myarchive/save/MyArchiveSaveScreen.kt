                ...
                items(count = savedCars.itemCount) { index ->
                    savedCars[index]?.run {
                        SavedCarFeed(
                            ...
                            exteriorColor = this.exteriorColor?.colorName ?: stringResource(id = R.string.error_no_color),
                            interiorColor = this.interiorColor?.colorName ?: stringResource(id = R.string.error_no_color),
